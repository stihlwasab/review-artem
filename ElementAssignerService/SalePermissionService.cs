namespace Lanit.Ksup.BLL.Service.ElementAssignerService
{
    ...
    /// <summary>
    /// Назначить права на элемент списка: "Продажи" и "Зависимые продажи"
    /// </summary>
    public class SalePermissionService : IElementPermissionsAssigner
    {
        /// <summary>
        ...
        public SalePermissionService(SPWeb elevatedWeb, SPUser author)
        {
        ...
        /// </summary>
        public SPContentTypeId ContentTypeId => PortalConstant.ContentType.Sale.Id;
        ...
        public void ApplyPermission(SPListItem item)
        {
            ...
            var parentLookupValue = item.LookupValue(PortalConstant.Field.KsupSaleOnly.Id);
